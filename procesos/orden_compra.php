    ...
    if($operation == "save")
    {
        ...
        else
        {
            ...
            foreach($codigos_insumos as $codigo)
            {
                ...
                $insumo_orden = mysql_query("INSERT INTO insumos_orden_compra (id_orden_compra, id_insumo, cantidad_solicitada) VALUES ('$id_orden_compra','".$insumo['id_insumo']."','".$cantidad_insumos[$i]."')");
                $i++;
            }
