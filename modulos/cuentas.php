    ...
    <body class="skin-blue">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li class="active"><a href="cuentas.php"><i class="fa fa-angle-double-right"></i> Usuarios del sistema</a></li>
                                <li class="treeview">
                                    <a href="pages/charts/flot.html">
                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $usuarios = mysql_query("SELECT * FROM usuarios WHERE id_usuario != 1 ");

                                            while($usuario = mysql_fetch_assoc($usuarios))
                                            {
                                                $privilegios = ['1'=>'Administrador','2'=>'Invitado'];
                                            ?>
                                            <tr>
                                                <td><a href="personal.php?cedula=<?=$usuario['cedula']?>" title="Ver información detallada"><?=$usuario['cedula']?></a></td>
                                                <td><?=$privilegios[$usuario['id_rol']]?></td>
                                                <td><?=$usuario['nombre_usuario']?></td>
                                                <td><?=$usuario['clave_usuario']?></td>
                                                <td>
                                                <a class="btn" href="gestion_cuenta.php?id=<?=$usuario['id_usuario']?>" title="Editar usuario">
                                                <i class="fa fa-pencil"></i></a>

                                                <a class="btn" href="../procesos/cuenta.php?operation=delete&id=<?=$usuario['id_usuario']?>" title="Eliminar usuario">
        ...
        <script type="text/javascript">
            $(function() {
                $('#example1').dataTable( {
                "oLanguage": {
                  "sInfo": "Mostrando del _START_ al _END_ de _TOTAL_ usuarios",
                  "sInfoFiltered": "(Filtrado de _MAX_ usuarios totales)",
                  "sInfoEmpty": "Mostrando del 0 al 0 de 0 usuarios",
                  "sEmptyTable": "No existen usuarios registrados."
                }
              } );
                $("#example1").dataTable();
                $('#example2').dataTable({
