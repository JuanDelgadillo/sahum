...
{
    $title = "Actualizar depósito";
    $deposito = mysql_fetch_assoc(mysql_query("SELECT * FROM depositos WHERE id_deposito = '$id' "));
    $nombre_deposito = $deposito['nombre_deposito'];
    $division_deposito = $deposito['id_division'];
}
else
{
         ...
         <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="depositos.php"><i class="fa fa-cogs"></i> Depósitos</a></li>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <form role="form" method="POST" action="../procesos/deposito.php">
                            <div class="col-md-4">
                            <!-- general form elements disabled -->
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label>División al que pertenece el depósito</label>
                                        <select name="division_deposito" class="form-control" required>
                                            ...
                                            {
                                                ?>
                                                <option <?php if($division_deposito == $division['id_division']) echo "SELECTED"; ?> value="<?=$division['id_division']?>"><?=$division['nombre_division']?></option>
                                                <?php
                                            }
                                            ?>
                                        </select>
                        ...
                        <div class="col-md-4">
                            <!-- general form elements disabled -->
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombre_deposito" value="<?=$nombre_deposito?>" class="form-control" placeholder="Nombre del depósito" required />
                                </div>
                        ...
                        <div class="col-md-4">
                            <!-- general form elements disabled -->
                                ...
                                <div class="box-footer">
                                        ...
                                        <button type="button" onclick="window.location='depositos.php'" class="btn">Cancelar</button>
                                    </div>
                        </div>
