                                ...
                                <div class="box-body table-responsive">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $insumos = mysql_query("SELECT * FROM insumos, depositos, secciones WHERE insumos.id_deposito = depositos.id_deposito AND insumos.id_seccion = secciones.id_seccion ");
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <a class="btn" href="nuevoInsumo.php?id=<?=$insumo['id_insumo']?>" title="Editar insumo">
                                                <i class="fa fa-pencil"></i></a>
                                                <a class="btn" href="../procesos/insumo.php?operation=delete&id=<?=$insumo['id_insumo']?>" title="Eliminar insumo">
