...
if(isset($id) && is_numeric($id) && $id != "")
{
    ...
    $marca = mysql_fetch_assoc(mysql_query("SELECT * FROM marcas WHERE id_marca = '$id' "));
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <form role="form" method="POST" action="../procesos/marca.php">
                            <div class="col-md-4">
                            <!-- general form elements disabled -->
                                ...
                                <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nombre_marca" value="<?=$nombre_marca?>" class="form-control" placeholder="Nombre de la marca" required />
                                        </div>
