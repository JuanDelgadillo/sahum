    ...
    <body class="skin-blue">
         ...
         <div class="wrapper row-offcanvas row-offcanvas-left">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="treeview active">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        <li class="active"><a href="conceptos_ingreso.php"><i class="fa fa-angle-double-right"></i> Conceptos de ingreso</a></li>
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>
                        SAHUM
                        <small>Conceptos de ingreso</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="../"><i class="fa fa-th"></i> Panel de control</a></li>
                        <li class="active">Conceptos de ingreso</li>
                    </ol>
                </section>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <?php
                                        ...
                                        ?>
                                    <a class="btn btn-app" href="gestion_concepto.php" title="Nuevo concepto de ingreso">
                                        <i class="fa fa-plus"></i> Nuevo
                                    </a>                                    
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>Nombre del concepto de ingreso</th>
                                                <th>Operaciones</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <a class="btn" href="gestion_concepto.php?id=<?=$concepto['id_concepto_ingreso']?>" title="Editar concepto de ingreso">
                                                <i class="fa fa-pencil"></i></a>

                                                <a class="btn" href="../procesos/concepto_ingreso.php?operation=delete&id=<?=$concepto['id_concepto_ingreso']?>" title="Eliminar concepto de ingreso">
        ...
        <script type="text/javascript">
            $(function() {
                $('#example1').dataTable( {
                "oLanguage": {
                  "sInfo": "Mostrando del _START_ al _END_ de _TOTAL_ conceptos",
                  "sInfoFiltered": "(Filtrado de _MAX_ conceptos totales)",
                  "sInfoEmpty": "Mostrando del 0 al 0 de 0 conceptos",
