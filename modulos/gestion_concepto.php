...
{
    $title = "Actualizar concepto de ingreso";
    $concepto = mysql_fetch_assoc(mysql_query("SELECT * FROM conceptos_ingreso WHERE id_concepto_ingreso = '$id' "));
         ...
         <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="conceptos_ingreso.php"><i class="fa fa-gears"></i> Conceptos de ingreso</a></li>
                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <form role="form" method="POST" action="../procesos/concepto_ingreso.php">
                            <div class="col-md-4">
                            <!-- general form elements disabled -->
                                ...
                                <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nombre_concepto" value="<?=$nombre_concepto?>" class="form-control" placeholder="Nombre del concepto" required />
                                        </div>
                        ...
                        <div class="col-md-4">
                            <!-- general form elements disabled -->
                                ...
                                <div class="box-footer">
                                        ...
                                        <button type="button" onclick="window.location='conceptos_ingreso.php'" class="btn">Cancelar</button>
                                    </div>
                        </div>
