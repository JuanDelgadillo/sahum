    ...
    <body class="skin-blue">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="treeview active">
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        <li class="active"><a href="laboratorios.php"><i class="fa fa-angle-double-right"></i> Laboratorios y marcas</a></li>
                                    </ul>
                                </li>
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Laboratorios y marcas</li>
                    </ol>
                </section>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <?php
                                        ...
                                        ?>
                                    <a class="btn btn-app" href="gestion_laboratorio.php" title="Nuevo laboratorio">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            {
                                                $cantidad_marcas = mysql_num_rows(mysql_query("SELECT * FROM marcas WHERE id_laboratorio = '".$laboratorio['id_laboratorio']."' "));
                                            ?>
                                            <tr>
                                                <td><?=$laboratorio['nombre_laboratorio']?></td>
                                                <td><?=$cantidad_marcas?></td>
                                                <td>
                                                <a class="btn" href="gestion_marca.php?laboratorio=<?=$laboratorio['id_laboratorio']?>" title="Agregar marca">
                                                <i class="fa fa-plus-square"></i></a>

                                                <a class="btn" href="marcas.php?laboratorio=<?=$laboratorio['id_laboratorio']?>" title="Ver marcas registradas">
                                                <i class="fa fa-indent"></i></a>

                                                <a class="btn" href="gestion_laboratorio.php?id=<?=$laboratorio['id_laboratorio']?>" title="Editar laboratorio">
                                                <i class="fa fa-pencil"></i></a>

                                                <a class="btn" href="../procesos/laboratorio.php?operation=delete&id=<?=$laboratorio['id_laboratorio']?>" title="Eliminar laboratorio">
        ...
        <script type="text/javascript">
            $(function() {
                $('#example1').dataTable( {
                "oLanguage": {
                  "sInfo": "Mostrando del _START_ al _END_ de _TOTAL_ laboratorios",
                  "sInfoFiltered": "(Filtrado de _MAX_ laboratorios totales)",
                  "sInfoEmpty": "Mostrando del 0 al 0 de 0 laboratorios",
                  "sEmptyTable": "No existen laboratorios registrados."
                }
              } );
                $("#example1").dataTable();
                $('#example2').dataTable({
