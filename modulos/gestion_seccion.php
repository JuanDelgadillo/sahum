                ...
                <section class="content">
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <form role="form" method="POST" action="../procesos/seccion.php">
                            <div class="col-md-4">
                            <!-- general form elements disabled -->
                                ...
                                <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nombre_seccion" value="<?=$nombre_seccion?>" class="form-control" placeholder="Nombre de la sección" required />
                                        </div>
