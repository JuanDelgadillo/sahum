    ...
    <body class="skin-blue">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="treeview active">
                                    ...
                                    <ul class="treeview-menu">
                                        <li class="active"><a href="depositos.php"><i class="fa fa-angle-double-right"></i> Depositos</a></li>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <?php
                                        ...
                                        ?>
                                    <a class="btn btn-app" href="gestion_deposito.php" title="Nuevo depósito">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            {
                                                $cantidad_secciones = mysql_num_rows(mysql_query("SELECT * FROM secciones WHERE id_deposito = '".$deposito['id_deposito']."' "));
                                            ?>
                                            <tr>
                                                <td><?=$deposito['nombre_deposito']?></td>
                                                <td><?=$cantidad_secciones?></td>
                                                <td>
                                                ...
                                                <a class="btn" href="../procesos/deposito.php?operation=delete&id=<?=$deposito['id_deposito']?>" title="Eliminar depósito">
        ...
        <script type="text/javascript">
            $(function() {
                $('#example1').dataTable( {
                "oLanguage": {
                  "sInfo": "Mostrando del _START_ al _END_ de _TOTAL_ depósitos",
                  "sInfoFiltered": "(Filtrado de _MAX_ depósitos totales)",
                  "sInfoEmpty": "Mostrando del 0 al 0 de 0 depósitos",
                  "sEmptyTable": "No existen depósitos registrados."
                }
              } );
                $("#example1").dataTable();
                $('#example2').dataTable({
